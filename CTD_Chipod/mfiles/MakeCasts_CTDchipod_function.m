...
%
% - Before running this you will need m-files:
%    Load_Chipod_paths...
%    Chipod_Deploy_Info...
%
% - You will also need to have processed the CTD data. These files should
...
if length(CTD_list)<1
    error('No CTD files were found. Is CTD_out_dir_24hz correct? Were CTD files processed?')
end
        ...
        try
            ...
            if  1 %~exist(processed_file,'file')
                ...
                if length(chidat.datenum)>1000
                    ...
                    % Save plot
                    print('-dpng',fullfile(chi_fig_path_specific,[whSN '_Cast_' castStr '_Fig1_RawChipodTS']))
                    ...
                    print('-dpng',fullfile(chi_fig_path_specific,[whSN '_Cast_' castStr '_Fig2_w_TimeOffset']))
                    ...
                    print('-dpng',fullfile(chi_fig_path_specific,[whSN '_Cast_' castStr '_Fig3_w_TimeOffset_Zoom']))
