function ctd=Compute_N2_dTdz_forChi_2(ctd)
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
%
% function ctd=Compute_N2_dTdz_forChi_2(ctd,z_smooth)
%
% ** no smoothing in this version **
%
...
[N2,q,pavg] = sw_bfrq(ctd.s1,ctd.t1,ctd.p,nanmean(ctd.lat)); %
ctd.N2 = interp1(pavg, N2, ctd.p);
...
ctd.dTdz = diffs(tmp1./diffs(ctd.p));
