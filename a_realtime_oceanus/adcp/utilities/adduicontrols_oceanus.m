...
guihands(1) =  uicontrol('Parent',h0,...        
           ...
           'ListboxTop',0, ...
           'fontsize',fsbox,...		   
           'Position',[x0 y0-0*(dy+spacev) dx dy], ...
...
guihands(2) =  uicontrol('Parent',h0,...
           ...
           'ListboxTop',0, ...
           'fontsize',fs,...		   
           'Position',[x0 y0-0*(dy+spacev)-dy dx dy], ...
...
guihands(3) =  uicontrol('Parent',h0,...        
           ...
           'ListboxTop',0, ...
           'fontsize',fsbox,...		   
           'Position',[x0 y0-1*(dy+spacev) dx dy], ...
           'Style','edit',...       % number in a box that can be edited
...
guihands(4) =  uicontrol('Parent',h0,...
           ...
           'ListboxTop',0, ...
           'fontsize',fs,...		   
           'Position',[x0 y0-1*(dy+spacev)-dy dx dy], ...
           'Style','text',...       % text that describes the box
...
%%%%%%%%%%% MAXIMUM DEPTH OS150 %%%%%%%%%%%
% GUI control for the box that determines the maximum depth of the OS150 (1) 
% and the corresponding text: "Max depth OS150" (2)
guihands(11) =  uicontrol('Parent',h0,...        
           'Units','normal', ...
           'BackgroundColor',backcol, ...
           'ListboxTop',0, ...
           'fontsize',fsbox,...		   
           'Position',[x0 y0-2*(dy+spacev) dx dy], ...
           'Style','edit',...       % number in a box that can be edited
           'String',num2str(plotinfo.ylim150(2)),...
           'foregroundcol',forecol);
guihands(12) =  uicontrol('Parent',h0,...
           'Units','normal', ...
           'BackgroundColor',backcol, ...
           'ListboxTop',0, ...
           'fontsize',fs,...		   
           'Position',[x0 y0-2*(dy+spacev)-dy dx dy], ...
           'Style','text',...       % text that describes the box
           'String',{'Max depth';'OS150 [m]'},...
           'foregroundcol',forecol);
...
guihands(5) =  uicontrol('Parent',h0,...
           ...
           'ListboxTop',0, ...
           'fontsize',fsbox,...		   
           'Position',[x0 y0-3*(dy+spacev) dx dy], ...
           'Style','edit',...       % number in a box that can be edited
...
guihands(6) =  uicontrol('Parent',h0,...
           ...
           'ListboxTop',0, ...
           'fontsize',fs,...		   
           'Position',[x0 y0-3*(dy+spacev)-dy dx dy], ...
           'Style','text',...       % text that describes the box
...
guihands(7) =  uicontrol('Parent',h0,...
           ...
           'ListboxTop',0, ...
           'fontsize',fsbox,...		   
           'Position',[x0 y0-4*(dy+spacev) dx dy], ...
           'Style','edit',...     % number in a box that can be edited
...
guihands(8) =  uicontrol('Parent',h0,...
           ...
           'ListboxTop',0, ...
           'fontsize',fs,...		   
           'Position',[x0 y0-4*(dy+spacev)-dy dx dy], ...
           'Style','text',...       % text that describes the box
           'String',{'Max |u|';'[m/s]'},...
           'foregroundcol',forecol);
...
guihands(9) =  uicontrol('Parent',h0,...
           ...
           'ListboxTop',0, ...
           'fontsize',fsbox,...		   
           'Position',[x0 y0-5*(dy+spacev) dx dy], ...
           'Style','edit',...     % number in a box that can be edited
...
guihands(10) =  uicontrol('Parent',h0,...
           ...
           'ListboxTop',0, ...
           'fontsize',fs,...		   
           'Position',[x0 y0-5*(dy+spacev)-dy dx dy], ...
           'Style','text',...       % text that describes the box
           'String',{'Max echo';'[dB]'},...
           'foregroundcol',forecol);
