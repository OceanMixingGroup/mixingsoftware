function ax=PlotBeamCorrsRTI(Vel,whfreq)
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
%
% ax=PlotBeamCorrsRTI(Vel,whfreq)
%
...
axes(ax(1))
ezpc(Vel.(['F' whfreq 'kHz']).dnum,Vel.(['F' whfreq 'kHz']).z,Vel.(['F' whfreq 'kHz']).corr1)
hold on
...
datetick('x')
SubplotLetterMW('1')
title([whfreq 'kHz Beam Correlations'])
xtloff
grid on

axes(ax(2))
ezpc(Vel.(['F' whfreq 'kHz']).dnum,Vel.(['F' whfreq 'kHz']).z,Vel.(['F' whfreq 'kHz']).corr2)
hold on
plot(Vel.(['F' whfreq 'kHz']).dnum,Vel.(['F' whfreq 'kHz']).bt_range0,'k.')
ylim(yl)
cb=colorbar
...
axes(ax(3))
ezpc(Vel.(['F' whfreq 'kHz']).dnum,Vel.(['F' whfreq 'kHz']).z,Vel.(['F' whfreq 'kHz']).corr3)
hold on
plot(Vel.(['F' whfreq 'kHz']).dnum,Vel.(['F' whfreq 'kHz']).bt_range0,'k.')
ylim(yl)
cb=colorbar
...
axes(ax(4))
ezpc(Vel.(['F' whfreq 'kHz']).dnum,Vel.(['F' whfreq 'kHz']).z,Vel.(['F' whfreq 'kHz']).corr4)
hold on
plot(Vel.(['F' whfreq 'kHz']).dnum,Vel.(['F' whfreq 'kHz']).bt_range0,'k.')
ylim(yl)
cb=colorbar
