...
bad_files={'YQ08a33_p_7','YQ08a40_p_8','YQ08a44_p_8','YQ08a54_p_7',...
    'YQ08a60_p_7','YQ08a62_p_7','YQ08a63_p_7','YQ08a68_p_8','YQ08a135_p_8',...
    'YQ08a140_p_8','YQ08a141_p_8','YQ08a161_p_7','YQ08a181_p_9','YQ08a189_p_5',...
    'YQ08a193_p_6','YQ08a245_p_8','YQ08a268_p_8','YQ08a310_p_7'};
probnames
...
% figure(8)
% clf
cols='rgbmckrgbmckrgbmckrgbmckrgbmckrgbmckrgbmckrgbmckrgbmckrgbmckrgbmck';
cls='rgbmcyk';
fn=fieldnames(transfer);
for a=1:length(fn)-1
    if ~strncmpi(fn{a},'p9999',5) && ~strcmpi(fn{a},'p0603P') % 9999 is marker for no-sensor, 0603P is bad
        clear h
        figure(8),clf
        leginp='';
...
transfer.readme={'smoothed_spec is the smoothed version of raw transfer spectra';
    '0603P is bad!'};
