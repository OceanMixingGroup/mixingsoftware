...
%     cham.filemax=q.script.num;
    ...
    cham.depthmax=max(round(max(avg.P)),cham.depthmax);
    cham.EPSILON1(f:t,n)=avg.EPSILON1(1:l)';
    cham.EPSILON2(f:t,n)=avg.EPSILON2(1:l)';
    cham.EPSILON(f:t,n)=avg.EPSILON(1:l)';
    cham.N2(f:t,n)=g*avg.DRHODZ(1:l)'./avg.SIGMA(1:l)';
    cham.SIGMA(f:t,n)=real(avg.SIGMA(1:l)');
    cham.CHI(f:t,n)= avg.CHI(1:l)';
    cham.THETA(f:t,n)=real(avg.THETA(1:l)');
    cham.T1(f:t,n)=real(avg.T1(1:l)');
    cham.T2(f:t,n)=real(avg.T2(1:l)');
