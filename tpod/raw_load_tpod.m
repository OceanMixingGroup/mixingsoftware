 function [data]= raw_load_tpod(filnam)
% load an 8-channel TPOD data file
...
% 05/02/2018 Pavan Vutukur: Used raw_load_gust template to create
% raw_load_tpod. The logger board H.Ware is same as gusT.
...
%     data.NULL = dout(1:end,4).*(4.096/65536);
    data.T2 = dout(1:end,5).*(4.096/65536);
    data.T1 = dout(1:end,6).*(4.096/65536);
    data.T3 = dout(1:end,7).*(4.096/65536);
    data.T4 = dout(1:end,8).*(4.096/65536);
