function avg=average_data_gen1_smallbins_for_T_S(series,varargin)
...
%% notes: SJW, June 2016
% Want an additional function that will calculate all the variables except
% epsilon and chi over smaller bins, say 10cm, for a shallow deployment
% like Concorde16
