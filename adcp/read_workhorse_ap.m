...
if nskip*nbytes<filelen-nbytes+1
  ...
  fprintf(1,'At end of file\n',nskip*nbytes);
  fseek(fin,0,'eof');
end;
pos=ftell(fin);
fprintf('%s, skipping %02d of %d bytes.  pos=%d\n',name,nskip*nbytes,filelen,pos);
