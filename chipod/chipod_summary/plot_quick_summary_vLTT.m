...
root = '\\ganges.ceoas.oregonstate.edu\work\Chipod\sw_reg_2023\long_term_container_test\1001\quick_summary\';

fnm =  [root,num2str(ichpd),'_quick_summary.mat'];
load(fnm); %loads the summary file

%CHANGE START AND END DATES OF DEPLOYMENT
%t.t1 = datenum('11-mar-2023 00:00:01','dd-mmm-yyyy HH:MM:SS');
...
quick_ticks(t,0,10,1,9,2);%ylim1,ylim2,ytick1,ytick2,tick_div
top_ax = gca;
taX= top_ax.XAxis;
set(taX,'tickdir','in');
ylabel('P dBar');
...
%CHANGE THE LIMITS AND TICKS
quick_ticks(t,-30,30,-20,20,10); %ylim1,ylim2,ytick1,ytick2,tick_div
...
%CHANGE THE LIMITS AND TICKS
quick_ticks(t,-1.03,-.91,-1.02,-.92,0.04);%ylim1,ylim2,ytick1,ytick2,tick_div
ylabel('A_Z (g_{force})')
...
%CHANGE THE LIMITS AND TICKS
quick_ticks(t,0,50,5,45,5); %ylim1,ylim2,ytick1,ytick2,tick_div
...
%CHANGE THE LIMITS AND TICKS
quick_ticks(t,-1,5,0,4,1);%ylim1,ylim2,ytick1,ytick2,tick_div
ylabel('Pitot (V)')
...
%CHANGE THE LIMITS AND TICKS
quick_ticks(t,6.7,7.3,6.8,7.2,0.1);%ylim1,ylim2,ytick1,ytick2,tick_div
