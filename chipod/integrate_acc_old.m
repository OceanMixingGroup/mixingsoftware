...
% Default value - 14400 (2min) 
% $Revision: 1.4 $ $Date: 2008/08/30 00:03:38 $ $Author: aperlin $
% Originally J.Moum
...
dt=1./(head.slow_samp_rate*head.submax_oversample);sr=1/dt;

[b,a]=butter(2,2*hpf_cutoff/sr,'high');

% extrapolate acc data
% extrapolate a VARIABLE over the
% extra NUMBER of points (default=14400)
% on both sides
len=length(cal.AX);
