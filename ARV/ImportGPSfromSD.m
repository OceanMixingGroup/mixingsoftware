...
% gps logger. Auto-generated by MATLAB import tool, then modified
%
%
%
...
%clear ; close all
%filename = '/Users/Andy/Cruises_Research/Mokai/GPSlogger/GPSLOG04.TXT';
%datfilename='/Users/Andy/Dropbox/ARV/Yaquina_2_April_2015/GPS/GPSLOG02.TXT'
...
for a=1:length(Date)
    ...
    rawtime=gmtTime{a};
    rawdate=Date{a};
    if str2num(rawdate(5:6))==15 % only save data from this year
