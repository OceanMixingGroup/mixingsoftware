...
%     load_file = [path_raw cruise_id '_' dummy(2:3) '.' dummy(4:6)];
    ...
    % (sjw 11/2014) calc_realtime_oceanus using calc_epsilon whereas
    % calc_realtime_oceanus_v2 using calc_epsilon_filt_gen and set_filters
% 	cali_realtime_oceanus
    cali_realtime_oceanus_v2
