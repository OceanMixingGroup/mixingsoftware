...
frompath = '\\pequod\data\dt\data\DT2001';
% this is the top-level directory in which the biosonics data is
% stored...

topath = '\\ladoga\datad\cruises\tx01\biosonics\DT2001';
	...
	for loop =1:length(subdir);
		...
		for loop2 = 1:length(subsubdir);
            ...
            for i=1:length(inds);
				...
				fout = sprintf('\\\\ladoga\\datad\\cruises\\tx01\\biosonics\\mat\\200110%02d%s.mat',str2num(day),thename(1:4));
