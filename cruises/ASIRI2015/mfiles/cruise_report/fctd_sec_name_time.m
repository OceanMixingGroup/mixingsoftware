...
fctd_names(secnum).et=datenum([2015 09 16 18 23 37]);
secnum=secnum+1;
...
fctd_names(secnum).name='secHome2'
fctd_names(secnum).st=datenum([2015 09 17 09 54 03]);
fctd_names(secnum).et=datenum([2015 09 20 01 51 32]);
secnum=secnum+1;
...
% fctd_names(5).st=datenum([2015 08 29 23 43 00]);
% fctd_names(6).st=datenum([2015 08 30 16 08 00]);
% fctd_names(7).st=datenum([2015 08 31 15 10 00]);
% fctd_names(8).st=datenum([2015 09 01 07 00 00]);
% fctd_names(9).st=datenum([2015 09 01 17 20 00]);
% fctd_names(10).st=datenum([2015 09 01 23 07 00]);
% fctd_names(11).st=datenum([2015 09 02 07 31 00]);
% fctd_names(12).st=datenum([2015 09 02 16 50 00]);
% fctd_names(13).st=datenum([2015 09 02 18 20 00]);
% fctd_names(14).st=datenum([2015 09 02 22 19 00]);
% fctd_names(15).st=datenum([2015 09 02 23 51 00]);
% fctd_names(16).st=datenum([2015 09 03 02 20 00]);
% fctd_names(17).st=datenum([2015 09 03 15 16 00]);
% fctd_names(18).st=datenum([2015 09 03 18 12 00]);
% fctd_names(19).st=datenum([2015 09 04 00 28 00]);
% fctd_names(20).st=datenum([2015 09 04 07 16 00]);
% fctd_names(21).st=datenum([2015 09 04 08 50 00]);
% fctd_names(22).st=datenum([2015 09 04 17 18 00]);
...
% fctd_names(4).et=datenum([2015 08 29 23 40 00]);
% fctd_names(5).et=datenum([2015 08 30 11 26 00]);
% fctd_names(6).et=datenum([2015 08 31 15 07 00]);
% fctd_names(7).et=datenum([2015 09 01 06 57 00]);
% fctd_names(8).et=datenum([2015 09 01 17 15 00]);
% fctd_names(9).et=datenum([2015 09 01 23 05 00]);
% fctd_names(10).et=datenum([2015 09 02 07 28 00]);
% fctd_names(11).et=datenum([2015 09 02 16 47 00]);
% fctd_names(12).et=datenum([2015 09 02 18 15 00]);
% fctd_names(13).et=datenum([2015 09 02 22 18 00]);
% fctd_names(14).et=datenum([2015 09 02 23 15 00]);
% fctd_names(15).et=datenum([2015 09 03 02 20 00]);
% fctd_names(16).et=datenum([2015 09 03 04 05 00]);
% fctd_names(17).et=datenum([2015 09 03 18 09 00]);
% fctd_names(18).et=datenum([2015 09 03 23 07 00]);
% fctd_names(19).et=datenum([2015 09 04 03 29 00]);
% fctd_names(20).et=datenum([2015 09 04 08 30 00]);
% fctd_names(21).et=datenum([2015 09 04 17 17 00]);
% fctd_names(22).et=datenum([2015 09 04 17 46 00]);
...
% fctd_names(29).st = 736213.428902083;       fctd_names(29).et = 736213.685690394;
% fctd_names(30).st = 736213.725137384;       fctd_names(30).et = 736213.981323727;
