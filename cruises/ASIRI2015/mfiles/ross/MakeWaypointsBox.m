...
% MakeWaypointsBox.m
%
% Script to generate a box for ROSS to travel to centered on ship position
%
...
ship_lat=13 + (27.277/60)% ship position
ship_lon=84 + (10.98/60)
ship_heading=180 % heading (want Ross to go away from ship initially)
...
[lon1,lat1,a21] = m_fdist(ship_lon,ship_lat,ship_heading-135,dist_from_ship)
...
map_aspectratio(gca)
lonvec=[lon1 ;lon2; lon3; lon4];
latvec=[lat1 ;lat2; lat3; lat4];
%
